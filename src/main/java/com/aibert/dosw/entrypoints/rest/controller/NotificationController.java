...
public class NotificationController {
    ...
    @Operation(
        ...
        description = "Called by other microservices (task-service, academic-service, planning-service, " +
    ...
    @Operation(
        ...
        description = "Returns the full notification history for the authenticated user, " +
    ...
    @Operation(
        ...
        description = "Returns study suggestion notifications generated for the current day. " +
    ...
    @Operation(
        ...
        description = "Returns overload and low-performance alert notifications created in the last 7 days. " +
